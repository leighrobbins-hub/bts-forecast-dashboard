...
var ROADMAP_LOCAL_SEED_DATA = [
    ...
    { id: 'inline-p90-util', title: 'Show P90 and Utilization values inline on Overview', category: 'Labels & Clarity', description: 'Where action text references high P90 or low utilization qualitatively, show the actual numeric value inline. Matches the format already used on other tabs.', priority: 'P0', status: 'In Progress' },
